        ...
        <div>
            ...
            <div>
                <div>
                    ...
                    <h1 className='YearsOld'>Лет</h1>
                    <h1 className='YearsOld2'>опыта</h1>
                </div>
                <div>
                    <p className='PortfolioNumberWorld'>20</p>
                    <img className='VectorTwo' src={VectorTwo}/> 
                    <h1 className='OficWorld'>Офисов</h1>
                    <h1 className='OficWorld2'> по миру</h1>
                </div>
                <div>
                    <p className='PortfolioOldProject'>350</p>
                    <img className='VectorTree' src={VectorThree}/> 
                    <h1 className='OldProject'>Выполненых</h1>
                    <h1 className='OldProject2'> проектов</h1>
